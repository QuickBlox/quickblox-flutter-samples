...
class AudioCallScreen extends StatelessWidget {
  static show(BuildContext context, bool isIncoming, List<QBUser?> opponents) {
    return Navigator.push(
        context, MaterialPageRoute(builder: (_) => AudioCallScreen(isIncoming: isIncoming, opponents: opponents)));
  }

  static showAndClearStack(BuildContext context, bool isIncoming, List<QBUser?> opponents) {
    Navigator.pushAndRemoveUntil(context,
        MaterialPageRoute(builder: (_) => AudioCallScreen(isIncoming: isIncoming, opponents: opponents)), (_) => false);
  }
        ...
        child: ChangeNotifierProvider<AudioCallScreenViewModel>(
            ...
            child: Scaffold(
                ...
                body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  UserNames(users: _viewModel.opponents ?? [QBUser()..fullName = "Unknown"]),
  ...
  Widget _buildTextCalling() {
    return const Padding(
        ...
        child: Text('Calling to',
            style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500, color: Color(0xFF90979F))));
  }
